...
fprintf(fileID,'#define Bp1 %f\n',Bp(1));
fclose(fileID);
for l = 2:length(Bp)
fileID = fopen('AandB.h','a');
...
fprintf(fileID,'#define R1 %f\n',R(1));
fclose(fileID);
for ll = 2:length(R)
fileID = fopen('RST.h','a');
fprintf(fileID,'#define R%d %f\n',ll,R(ll));
fclose(fileID);    
end
for lll = 1:length(S)
fileID = fopen('RST.h','a');
fprintf(fileID,'#define S%d %f\n',lll,S(lll));
fclose(fileID);    
end
for l = 1:length(T)
fileID = fopen('RST.h','a');
fprintf(fileID,'#define T%d %f\n',l,T(l));
fclose(fileID);    
end
